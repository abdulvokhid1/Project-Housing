...
const PhotoWord = styled.p`
  ...
  margin-top: 15px;
`;
const Photo_Wrapper = styled.div`
  display: flex;
  flex-direction: column;
  /* margin-left: 15px;
  margin-right: 15px; */
